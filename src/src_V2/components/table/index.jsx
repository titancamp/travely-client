            ...
            <MuiTable>
                <TableHead>
                    {head.map(({ content, key, styles: style = {} }) => (
                        <TableCell component='div' key={key} sx={[style, styles.headCell]} variant='head' size='small'>
                            ...
                            >
                                {columns.map(({ key, content, defaultContent, styles }) => (
                                    <TableCell sx={styles} key={key} variant='body' size='small'>
                                        {typeof content === 'function' ? content(data) : content ?? defaultContent}
                                    </TableCell>
                                ))}
                            </TableRow>
                        ))}
                ...
                {(hasPagination && rows.length !== 0) && (<TableFooter component='div'>
