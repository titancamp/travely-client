      ...
      <Grid container>
            ...
            subheader={
              <Grid container spacing={2}>
                <Grid item sx={styles.iconWithInfo}>
                  ...
                  <Typography variant='caption'>{todo.reminder}</Typography>
                </Grid>
                <Grid item sx={styles.iconWithInfo}>
                  <LocationOn sx={styles.icon} />
                  <Typography variant='caption'>{tourLocation}</Typography>
                </Grid>
              </Grid>
            }
          />
        ...
        >
          <CardContent sx={styles.content(todo.status === TaskStatus.ARCHIVED)}>
            {!expanded && (
              <>
                ...
                {drawCollapseText && (
                  <Typography color='primary' variant='subtitle2' onClick={toggle}>
                    Read all
                  </Typography>
                )}
              </>
          ...
          {todo.status === TaskStatus.ARCHIVED && (
            <IconButton sx={{ alignSelf: 'center' }} onClick={restoreTask}>
              <SettingsBackupRestore />
            </IconButton>
          )}
        </Grid>
