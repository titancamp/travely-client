            ...
            <Grid container spacing={3}>
                <Grid item className={styles.chartContainer}>
                    ...
                    <Grid container spacing={5} className={styles.charts}>
                        <Grid item>
                            <Typography fontWeight={500} className={styles.chartTitle}>Income & Expense</Typography>
                            <LineChart
                                width={320}
                                height={250}
                                data={MOCK_DATA}
                            >
                                ...
                                <XAxis dataKey="year" />
                                <YAxis />
                                <Line type="monotone" dataKey="income" stroke="#903FE0" activeDot={{ r: 8 }} />
                        ...
                        <Grid item>
                            <Typography fontWeight={500} className={styles.chartTitle}>Completed & Cancelled Tours</Typography>
                            <LineChart
                                width={320}
                                height={250}
                                data={MOCK_DATA}
                            >
                                ...
                                <XAxis dataKey="year" />
                                <YAxis />
                                <Line type="monotone" dataKey="income" stroke="#3FE0C3" activeDot={{ r: 8 }} />
                ...
                <Grid item>
                    <Grid container direction='column' rowSpacing={3}>
                        ...
                        <Grid item className={`${styles.analyticsItem} ${styles.upcomingAnalytics}`}>
