                        ...
                        <Grid container direction="row" justify="space-between" spacing={1}>
                            ...
                            <Grid item xs={6}>
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={6}>
                                        <InputLabel className={classes.label}>Checkin Date</InputLabel>
                                        <TextField
                                            fullWidth
                                            variant="outlined"
                                            size="small"
                                            ...
                                            helperText={formik.errors.checkinDate ? formik.errors.checkinDate : ""}
                                            value={formik.values.checkinDate}
                                            onChange={formik.handleChange}
                                        />
                                    </Grid>
                                    <Grid item xs={6}>
                                        <InputLabel className={classes.label}>Checkout Date</InputLabel>
                                        <TextField
                                            fullWidth
                                            variant="outlined"
                                            size="small"
                                            ...
                                            helperText={formik.errors.checkoutDate ? formik.errors.checkoutDate : ""}
                                    ...
                                    <Grid item xs={12}>
                                        ...
                                        >
                                            <InputLabel id="bookingStateLbl">Booking State</InputLabel>
                                            <Select
                                                variant="outlined"
                                                id="bookingState"
                                                name="bookingState"
                                                                ...
                                                                <Grid item xs={4}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <Select
                                                                            ...
                                                                            label="Room Guests"
                                                                            value={formik.values.rooms[index].roomGuests}
                                                                            onChange={formik.handleChange}
                                                                        >
                                                                            <MenuItem value="">
                                                                                <em>None</em>
                            ...
                            <Grid item xs={6}>
                                <InputLabel className={classes.label}>Cancellation Date</InputLabel>
                                <TextField
                                    fullWidth
                                    variant="outlined"
                                    size="small"
                                    ...
                                    helperText={formik.errors.cancellationDate ? formik.errors.cancellationDate : ""}
