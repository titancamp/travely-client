          ...
          <Box component="div" display="flex" justifyContent="space-between">
            <Box component="span">
              ...
              >
                ...
                <Box component="span" width="48%" clone>
                  <FormikInputField label="Issued by" name="issuedBy" />
                </Box>
              </Box>
              <Box
                component="div"
              ...
              >
                <Box component="span" width="48%" clone>
                  <FormikInputField label="Issue date" name="issueDate" />
                </Box>
                <Box component="span" width="48%" clone>
                  <FormikInputField label="Expire date" name="expireDate" />
                </Box>
              </Box>
            ...
            <Box component="span" displey="flex" alignItems="flex-end">
              <FormikCheckbox label="Main contact" name="mainContact" />
