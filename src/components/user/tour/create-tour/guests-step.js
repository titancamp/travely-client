...
const Guests = (props) => {
  ...
  const handleSearchGuestChange = useCallback(
    (event, selectedGuest) => {
      if (selectedGuest) {
        formik.setValues({
          ...selectedGuest,
            ...
            <Grid container spacing={1}>
              ...
              <Grid item xs={12}>
                <Autocomplete
                  ...
                  getOptionLabel={(option) =>
                    option &&
                    `${option.firstName} ${option.lastName} ${option.email} ${option.passportNumber}`
                  }
                  renderInput={(params) => {
                    return (
                      <TextField
              ...
              <Grid item xs={6}>
                ...
                <TextField
                  ...
                  helperText={
                    formik.errors.placeOfBirth ? formik.errors.placeOfBirth : ""
                  }
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  helperText={
                    formik.errors.issuedBy ? formik.errors.issuedBy : ""
                  }
